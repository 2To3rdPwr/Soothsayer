...
include(":screen:Greeting:public")
include(":screen:Greeting:impl")
include(":library:Navigation:public")
include(":library:Navigation:impl")
include(":library:TopNavBar:public")
include(":library:TopNavBar:impl")
...
include(":data:Domain:public")
include(":data:Domain:impl")
include(":screen:ManageCharacter:public")
include(":screen:ManageCharacter:impl")
include(":library:Dice:public")
include(":library:Dice:impl")
